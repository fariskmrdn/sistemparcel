...
<head>
	...
	<title>e-PARCEL KVKS ADMIN</title>
...
<div class="container-fluid padding" style="margin-top: 20px;">
  		...
  		<div class="row mx-auto justify-content-center">
  			<div class="col-xs-3 col-sm-2 col-md-3 col-lg-3 col-xl-5 padding">
				  ...
				  <hr>
				  <h2 style="text-align:center;">ADMINISTRATION MODULE</h2>
				  <hr>
				  <p style="text-align:center;">Choose Admin Module</p>
  			</div>
          ...
          <div class="container-fluid padding justify-content-center">
			<div class="row text-center padding">
				...
				<div class="col-xs-6 col-sm-6 col-md-7">
                    <a style="text-decoration:none;color:black;" href="mpplogin.php">
					<img src="images/btnmpp.png" class="img-fluid" width="300">
					<br><br>
					<h3></h3>
					<p></p></a>
				</div>
				...
				<div class="col-xs-6 col-sm-6 col-md-3">
                    <a style="text-decoration:none;color:black;" href="heplogin.php">
					<img src="images/btnhep.png" class="img-fluid" width="300">
					<br><br><br>
					<h3></h3>
