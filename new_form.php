<?php
	...
	if (isset($_POST['add'])) {
		...
		$mppincharge = $_POST['mpp'];

		$insertCmd = "INSERT INTO `inventory` (`receiver`, `tel`, `consignment`, `courier`, `arrival`, `assigned`) VALUES ('$receiver', '$telno', '$consignment', '$courier', '$arrival', '$mppincharge')";
...
<div class="container-fluid padding" style="margin-top: 20px;">
  		...
  		<div class="row mx-auto justify-content-center">
  			...
  			<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 col-xl-2 padding">
  				<p class="lead padding" style="text-align: center;">ADD NEW PARCEL</p></p>
				...
				<table style="" cellpadding="10"  class="table-responsive p-auto justify-content-center">
  					<thead>
						...
						<tr>
      						...
      						<th>:</th>
      						<td><input type="text" name="mpp" class="form-control" value="<?=$dataR['name'];?>"></td>
    					</tr>
                        <tr>
                            <td>
