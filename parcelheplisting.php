...
<div class="container-fluid padding" style="margin-top: 20px;">
  		...
  		<div class="row mx-auto justify-content-center">
  			...
  			<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 col-xl-2 padding">
                ...
                <p><button type="button" class="btn btn-success" onclick="location.href='delivered_parcelhep.php';"><b>PARCEL DELIVERED</b></button></p>
  				<hr>
  			</div>
  		</div>
          ...
          <div class="row mx-auto justify-content-center padding">
            ...
            <table class="table table-striped" cellpadding="25">
                   ...
                   $listParcel = "SELECT * FROM inventory_hep ORDER BY arrival DESC";
                   $findList = mysqli_query($connect,$listParcel);
                    ...
                    while ($list = mysqli_fetch_array($findList)) {
                        ...
                        <tr>
                            ...
                            <td>".$list['arrival']."</td>
                            <td>".$list['assigned']."</td>
                            <td><a class='btn btn-success' href='hepcheckout.php?consignment=".$list['consignment']."'>CHECKOUT</a></td>
                            <td><a class='btn btn-danger' onclick=\"return confirm('Are you sure to delete this parcel? Be advised this parcel will be deleted permanently!');\" href='hep_deleterecord.php?consignment=".$list['consignment']."'>DELETE</a></td>
                        </tr>
                        ";
                    }
