...
<div class="container-fluid padding" style="margin-top: 20px;">
          ...
          <div class="row mx-auto justify-content-center padding">
            ...
            <p><button type="button" class="btn btn-primary" onclick="location.href='searchhep.php';"><b>Search Other Parcel</b></button></p>
			</div>
                           ...
                           while ($data = mysqli_fetch_array($findP)) {
                               echo "
                                   <tr>
                                       ...
                                       <td>".$data['arrival']."</td>
                                       <td>".$data['assigned']."</td>
                                       <td><a class='btn btn-success' href='hep_checkout.php?consignment=".$data['consignment']."'>CHECKOUT PARCEL</a></td>
                                   </tr>
                           ";}
                       ?>
               </table>
