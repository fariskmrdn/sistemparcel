<?php
    ...
    if (isset($_GET['search'])) {
        ...
        $searchQ = "SELECT * FROM inventory_hep WHERE consignment LIKE '%$find%' OR receiver LIKE '%$find%'";
...
<head>
	...
	<title>SEARCH LECTURER / STAFF PARCEL</title>
...
<div class="container-fluid padding" style="margin-top: 20px;">
  		...
  		<div class="row mx-auto justify-content-center">
  			...
  			<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 col-xl-2 padding">
  				<p class="lead padding" style="text-align: center;">SEARCH LECTURER / STAFF PARCEL</p></p>
          ...
          <div class="row mx-auto justify-content-center padding">
            ...
            <p><button type="button" class="btn btn-primary" onclick="location.href='hep_parcel.php';"><b>Search Other Parcel</b></button></p>
			</div>
...
<?php     
            ...
            <script>
                ...
                window.location = 'hep_parcel.php';
            </script>
            ";
        } }
        ?>