          ...
          <div class="container-fluid padding justify-content-center">
			<div class="row text-center padding">
				...
				<div class="col-xs-6 col-sm-6 col-md-4">
                    <a style="text-decoration:none;color:black;" href="parcelregisterhep.php">
				...
				<div class="col-xs-6 col-sm-6 col-md-4">
                    <a style="text-decoration:none;color:black;" href="searchhep.php">
				...
				<div class="col-sm-6 col-md-4">
                    <a style="text-decoration:none;color:black;" href="parcelheplisting.php">
